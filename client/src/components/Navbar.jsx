            ...
            <div>
                {user === null ?
                    <div className='flex items-center gap-2 sm:gap-4 md:gap-6 text-[#49545b]'>
                        ...
                        <button onClick={() => setShowLogin(true)} className='px-6 sm:px-8  md:px-10  py-1 sm:py-2 md:py-3 bg-black text-white rounded-full'>Login</button>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        <div className='flex items-center gap-2 text-[#49545b] relative group'>
                            <p className='hidden md:block'>Hi! Akash</p>
                            ...
                            <div className='absolute top-[100%] right-0  w-full bg-transparent md:pl-8 py-3 hidden  group-hover:block'>
                                <ul className='relative '>
                                    ...
                                    <li onClick={() => setUser(null)} className='border-2 cursor-pointer bg-teal-50 px-2 py-1 z-0'>Logout</li>
                                </ul>
                            </div>
                        </div>
